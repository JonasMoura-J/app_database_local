...
class PaginaTipoProduto extends StatefulWidget with PaginaEntidade {
  ...
  @override
  _PaginaTipoProdutoState createState() => _PaginaTipoProdutoState();
}

class _PaginaTipoProdutoState extends State<PaginaTipoProduto>
  ...
  bool dadosCorretos(BuildContext contexto) {
    ...
    if ((tipoProduto.nome == null) || (tipoProduto.nome == '')) {
      informar(contexto, 'É necessário informar o nome.');
      return false;
    }
    return true;
  }
